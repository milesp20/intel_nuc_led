...
def query_led_control_items(led_type, led_indicator_option, control_file=None):
    ...
    write_control_file(query_led_control_item_byte_list, control_file=control_file)
...
def query_led_indicator_options(led_type, control_file=None):
    """
    ...
    write_control_file(query_led_indicator_options_byte_list, control_file=control_file)
